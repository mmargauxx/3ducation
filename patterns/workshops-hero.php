...
<figure class="wp-block-image size-large hero-photo"><img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/workshops-hero-2026.jpg' ) ); ?>" alt="<?php echo esc_attr__( 'Een medewerker legt aan een jongen uit hoe 3D-printen werkt, aan de toonbank in de winkel.', '3ducation' ); ?>"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->
