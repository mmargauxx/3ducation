<?php
/**
 * Title: Oplossingen — scholen &amp; thuis
 * Slug: 3ducation/solutions
 * Categories: 3ducation
 * Description: The two audiences of the Webshop & oplossingen pillar — schools (educatieve pakketten) and home users (voorgemonteerde printers).
 */
?>
...
<!-- wp:heading {"level":2} -->
<h2 class="wp-block-heading">3D-printen op school: educatieve pakketten</h2>
<!-- /wp:heading -->
...
<div class="wp-block-button is-style-outline"><a class="wp-block-button__link wp-element-button" href="/educatieve-pakketten">Bekijk de pakketten</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column -->
...
<ul class="wp-block-list wsaud-list"><!-- wp:list-item --><li>3D-printer(s) naar eigen keuze</li><!-- /wp:list-item -->
<!-- wp:list-item --><li>Installatie van printer &amp; software</li><!-- /wp:list-item -->
<!-- wp:list-item --><li>Lerarenopleiding (± 2 uur)</li><!-- /wp:list-item -->
...
<!-- wp:list {"className":"wsaud-list"} -->
<ul class="wp-block-list wsaud-list"><!-- wp:list-item --><li>Voorgemonteerd geleverd</li><!-- /wp:list-item -->
<!-- wp:list-item --><li>Getest en klaar voor gebruik</li><!-- /wp:list-item -->
<!-- wp:list-item --><li>Combineerbaar met een workshop</li><!-- /wp:list-item -->
<!-- wp:list-item --><li>Lokale support en herstelling</li><!-- /wp:list-item --></ul>
<!-- /wp:list --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<!-- wp:heading {"level":2} -->
<h2 class="wp-block-heading">3D-printers voor thuis</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"color":{"text":"var:preset|color|ink-soft"}},"fontSize":"large"} -->
<p class="has-text-color has-large-font-size" style="color:var(--wp--preset--color--ink-soft)">Direct zelf aan de slag? Kies voor een voorgemonteerde 3D-printer uit onze webshop. Combineer je aankoop met een praktische workshop zodat je meteen je eerste succesvolle prints realiseert.</p>
<!-- /wp:paragraph -->
...
<!-- wp:buttons {"style":{"spacing":{"blockGap":"var:preset|spacing|30"}}} -->
<div class="wp-block-buttons"><!-- wp:button -->
<div class="wp-block-button"><a class="wp-block-button__link wp-element-button" href="/shop">Bekijk het aanbod</a></div>
<!-- /wp:button -->

<!-- wp:button {"className":"is-style-outline"} -->
<div class="wp-block-button is-style-outline"><a class="wp-block-button__link wp-element-button" href="/workshops">Combineer met een workshop</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
