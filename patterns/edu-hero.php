...
/**
 * Title: Educatie hero
 * Slug: 3ducation/edu-hero
 * Categories: 3ducation, banner
 * Description: Intro for the Educatieve pakketten page — 3D-printen op school, with a classroom photo alongside.
 */
?>
...
<div class="wp-block-group"><!-- wp:paragraph {"style":{"typography":{"textTransform":"uppercase","letterSpacing":"3px","fontWeight":"500"},"color":{"text":"var:preset|color|cyan"}},"fontSize":"small","fontFamily":"display"} -->
<p class="has-text-color has-display-font-family has-small-font-size" style="color:var(--wp--preset--color--cyan);font-weight:500;letter-spacing:3px;text-transform:uppercase">Voor scholen · Educatieve pakketten</p>
<!-- /wp:paragraph -->

<!-- wp:heading {"level":1,"style":{"typography":{"fontSize":"clamp(2.5rem, 5.5vw, 4rem)"}}} -->
<h1 class="wp-block-heading" style="font-size:clamp(2.5rem, 5.5vw, 4rem)">3D-printen op school!</h1>
<!-- /wp:heading -->
...
<p class="has-text-color" style="color:var(--wp--preset--color--ink-soft)">De 3D-printer hoort thuis in het lesprogramma van basis- en secundaire scholen. Hieronder enkele combinatiemogelijkheden: de keuze van de printers is volledig vrij, en we geven advies volgens de noden van je school.</p>
<!-- /wp:paragraph -->
...
<figure class="wp-block-image size-large hero-photo"><img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/edu-hero-2026.jpg' ) ); ?>" alt="<?php echo esc_attr__( 'Een rood geprint draakje op een 3D-printer, met een spoel blauw filament ernaast.', '3ducation' ); ?>"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->
