<?php
/**
 * Title: Oplossingen hero
 * Slug: 3ducation/solutions-hero
 * Categories: 3ducation, banner
 * Description: Lead-in for the Webshop & oplossingen pillar page — one funnel for schools (B2B) and home users (B2C).
 */
?>
...
<p class="has-text-color has-display-font-family has-small-font-size" style="color:var(--wp--preset--color--magenta);font-weight:500;letter-spacing:3px;text-transform:uppercase">Webshop &amp; oplossingen</p>
<!-- /wp:paragraph -->

<!-- wp:heading {"level":1,"style":{"typography":{"fontSize":"clamp(2.5rem, 5.5vw, 4rem)"}}} -->
<h1 class="wp-block-heading" style="font-size:clamp(2.5rem, 5.5vw, 4rem)">De juiste 3D-printer, met de kennis om ermee te werken</h1>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"color":{"text":"var:preset|color|ink-soft"}},"fontSize":"large"} -->
<p class="has-text-color has-large-font-size" style="color:var(--wp--preset--color--ink-soft)">Of je nu een school bent die 3D-printen in het lesprogramma wil brengen, of thuis meteen zelf aan de slag wil: je koopt geen doos, je koopt vertrouwen. We adviseren op maat en zorgen dat je toestel ook echt gebruikt wordt.</p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button"><a class="wp-block-button__link wp-element-button" href="#scholen">Voor scholen</a></div>
<!-- /wp:button -->

<!-- wp:button {"className":"is-style-outline"} -->
<div class="wp-block-button is-style-outline"><a class="wp-block-button__link wp-element-button" href="#thuis">Voor thuis</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
