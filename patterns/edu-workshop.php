<?php
/**
 * Title: Educatie workshop
 * Slug: 3ducation/edu-workshop
 * Categories: 3ducation
 * Description: "Wat mag je verwachten van de workshop?" — the shared workshop description, three steps, and a closing offer CTA.
 */
?>
...
<div class="wp-block-group alignwide" style="padding-top:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--60)"><!-- wp:group {"layout":{"type":"constrained","contentSize":"820px"}} -->
<div class="wp-block-group"><!-- wp:heading {"level":2} -->
<h2 class="wp-block-heading">Wat mag je verwachten van de workshop?</h2>
<!-- /wp:heading -->
...
<h3 class="wp-block-heading has-large-font-size">Installatie</h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"color":{"text":"var:preset|color|ink-soft"}}} -->
<p class="has-text-color" style="color:var(--wp--preset--color--ink-soft)">Installatie van de 3D-printer en de configuratie van de 3D-software, zodat alles klaar staat om te gebruiken.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->

<!-- wp:column -->
<div class="wp-block-column"><!-- wp:paragraph {"className":"print-eyebrow print-eyebrow--cyan","fontSize":"small","fontFamily":"display"} -->
<p class="print-eyebrow print-eyebrow--cyan has-display-font-family has-small-font-size">Stap 2 · De printer</p>
<!-- /wp:paragraph -->

<!-- wp:heading {"level":3,"fontSize":"large"} -->
<h3 class="wp-block-heading has-large-font-size">Leren printen</h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"color":{"text":"var:preset|color|ink-soft"}}} -->
<p class="has-text-color" style="color:var(--wp--preset--color--ink-soft)">Hoe werkt de 3D-printer? We leren je vlot en zelfstandig met het toestel omgaan.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<!-- wp:heading {"level":3,"fontSize":"large"} -->
<h3 class="wp-block-heading has-large-font-size">Leren ontwerpen</h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"color":{"text":"var:preset|color|ink-soft"}}} -->
<p class="has-text-color" style="color:var(--wp--preset--color--ink-soft)">Uitleg van de printsoftware en de ontwerpprogramma's, zodat je eigen modellen kan maken.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->
...
<div class="wp-block-button"><a class="wp-block-button__link wp-element-button" href="mailto:info@3ducation.be?subject=Offerte%20educatief%20pakket">Offerte aanvragen</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
