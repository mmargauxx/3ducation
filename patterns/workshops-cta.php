...
/**
 * Title: Workshops CTA
 * Slug: 3ducation/workshops-cta
 * Categories: 3ducation, call-to-action
 * Description: Call-to-action band promoting the workshops.
 */
?>
...
<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:66%"><!-- wp:paragraph {"style":{"typography":{"textTransform":"uppercase","letterSpacing":"2px","fontWeight":"500"},"color":{"text":"var:preset|color|amber"}},"fontSize":"small","fontFamily":"display"} -->
<p class="has-text-color has-display-font-family has-small-font-size" style="color:var(--wp--preset--color--amber);font-weight:500;letter-spacing:2px;text-transform:uppercase">Workshops</p>
<!-- /wp:paragraph -->
