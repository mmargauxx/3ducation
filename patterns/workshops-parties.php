...
<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:42%"><!-- wp:group {"className":"info-panel info-panel--amber","layout":{"type":"constrained"}} -->
...
<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:58%"><!-- wp:paragraph {"className":"print-eyebrow print-eyebrow--amber","fontSize":"small","fontFamily":"display"} -->
<p class="print-eyebrow print-eyebrow--amber has-display-font-family has-small-font-size">Verjaardagsfeestjes</p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button"><a class="wp-block-button__link wp-element-button" href="mailto:info@3ducation.be?subject=Verjaardagsfeestje%20in%203D">Reserveer je feestje</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
